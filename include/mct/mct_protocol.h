...
enum mct_publisher_services {
    ...
    MCT_SERVICE_ID_RESERVED_B = 0xF0B,
    MCT_SERVICE_ID_RESERVED_C = 0xF0C,
    MCT_SERVICE_ID_RESERVED_D = 0xF0D,
    MCT_SERVICE_ID_RESERVED_E = 0xF0E,
