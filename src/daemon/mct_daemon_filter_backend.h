 ...
 */
static inline int mct_daemon_filter_backend_init(DltDaemonLocal *daemon_local,
 ...
 * @return 0 on success, -1 otherwise
 */
static inline int mct_daemon_filter_backend_deinit(DltDaemonLocal *daemon_local,
                                                   int verbose)
{
    (void)daemon_local;
    (void)verbose;
