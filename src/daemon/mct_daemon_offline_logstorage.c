 ...
 */
DLT_STATIC DltReturnValue mct_logstorage_split_ecuid(char *key,
                                                     int len,
                                                     char *ecuid,
                                                     char *apid,
                                                     char *ctid)
 ...
 * @return               0 on success -1 on error
 */
DLT_STATIC DltReturnValue mct_logstorage_split_ctid(char *key,
                                                    int len,
                                                    char *apid,
                                                    char *ctid)
{
 ...
 * @return               0 on success -1 on error
 */
DLT_STATIC DltReturnValue mct_logstorage_split_apid(char *key,
                                                    int len,
                                                    char *apid,
                                                    char *ctid)
{
 ...
 * @return               0 on success -1 on error
 */
DLT_STATIC DltReturnValue mct_logstorage_split_apid_ctid(char *key,
                                                         int len,
                                                         char *apid,
                                                         char *ctid)
{
 ...
 * @return               0 on success -1 on error
 */
DLT_STATIC DltReturnValue mct_logstorage_split_ecuid_apid(char *key,
                                                          int len,
                                                          char *ecuid,
                                                          char *apid,
                                                          char *ctid)
 ...
 * @return               None
 */
DLT_STATIC DltReturnValue mct_logstorage_split_multi(char *key,
                                                     int len,
                                                     char *ecuid,
                                                     char *apid,
                                                     char *ctid)
 ...
 * @return         0 on success, -1 on error
 */
DLT_STATIC DltReturnValue mct_logstorage_split_key(char *key, char *apid,
 ...
 */
DLT_STATIC DltReturnValue mct_daemon_logstorage_update_passive_node_context(
 ...
 * @return                  0 on success, -1 on error
 */
DLT_STATIC DltReturnValue mct_daemon_logstorage_send_log_level(DltDaemon *daemon,
                                                               DltDaemonLocal *daemon_local,
 ...
 * @return                  0 on success, -1 on error
 */
DLT_STATIC DltReturnValue mct_daemon_logstorage_reset_log_level(DltDaemon *daemon,
                                                                DltDaemonLocal *daemon_local,
                                                                DltDaemonContext *context,
                                                                char *ecuid,
                                                                int loglevel,
 ...
 * @return                  0 on success, -1 on error
 */
DLT_STATIC DltReturnValue mct_daemon_logstorage_force_reset_level(DltDaemon *daemon,
                                                                  DltDaemonLocal *daemon_local,
                                                                  char *apid,
                                                                  char *ctid,
                                                                  char *ecuid,
 ...
 * mct_logstorage_write function is not able to write to the device, DltDaemon
