...
#define DLT_OFFLINE_LOGSTORAGE_CONFIG_FILE_NAME    "mct_logstorage.conf"
...
struct DltLogStorageFilterConfig
{
    ...
    int (*mct_logstorage_prepare)(DltLogStorageFilterConfig *config,
                                  DltLogStorageUserConfig *file_config,
                                  char *dev_path,
                                  int log_msg_size,
                                  DltNewestFileName *newest_file_info);
    int (*mct_logstorage_write)(DltLogStorageFilterConfig *config,
                                DltLogStorageUserConfig *file_config,
                                char *dev_path,
                                unsigned char *data1,
                                int size1,
    ...
    int (*mct_logstorage_sync)(DltLogStorageFilterConfig *config,
...
typedef enum {
    DLT_LOGSTORAGE_CONFIG_FILE = 0,   /* Use mct-logstorage.conf file from device */
 ...
 */
int mct_logstorage_device_connected(DltLogStorage *handle,
 ...
 * @return               0 on success, -1 on error
 */
int mct_logstorage_device_disconnected(DltLogStorage *handle,
                                       int reason);
/**
